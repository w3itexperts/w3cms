                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @can('Controllers > RolesController > edit')
                                                <a href="{{ route('admin.roles.edit', $role->id) }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="icon-pencil"></i></a>
                                            @endcan
                                            @can('Controllers > RolesController > destroy')
                                                <a href="{{ route('admin.roles.delete', $role->id) }}" class="btn btn-danger shadow btn-xs sharp me-1"><i class="icon-trash-2"></i></a>
                                            @endcan
                                        </td>
                                    </tr>
                                @empty
