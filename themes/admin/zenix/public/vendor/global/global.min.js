...
dzSettings.prototype.manageSidebarBg = function() {
    switch(this.sidebarBg) {
        case "color_1": 
            body.attr("data-sidebar_bg", "color_1");
            break;
        case "color_2": 
            body.attr("data-sidebar_bg", "color_2");
            break;
        case "color_3": 
            body.attr("data-sidebar_bg", "color_3");
            break;
        case "color_4": 
            body.attr("data-sidebar_bg", "color_4");
            break;
        case "color_5": 
            body.attr("data-sidebar_bg", "color_5");
            break;
        case "color_6": 
            body.attr("data-sidebar_bg", "color_6");
            break;
        case "color_7": 
            body.attr("data-sidebar_bg", "color_7");
            break;
        case "color_8": 
            body.attr("data-sidebar_bg", "color_8");
            break;
        case "color_9": 
            body.attr("data-sidebar_bg", "color_9");
            break;
        case "color_10": 
            body.attr("data-sidebar_bg", "color_10");
            break;
		case "color_11": 
            body.attr("data-sidebar_bg", "color_11");
            break;
		case "color_12": 
            body.attr("data-sidebar_bg", "color_12");
            break;
		case "color_13": 
            body.attr("data-sidebar_bg", "color_13");
            break;
		case "color_14": 
            body.attr("data-sidebar_bg", "color_14");
            break;
		case "color_15": 
            body.attr("data-sidebar_bg", "color_15");
            break;			
        case "image_1": 
            body.attr("data-sidebar_bg", "image_1");
            break;
        case "image_2": 
            body.attr("data-sidebar_bg", "image_2");
            break;
        case "image_3": 
            body.attr("data-sidebar_bg", "image_3");
            break;
        default:
            body.attr("data-sidebar_bg", "color_1");
    }
