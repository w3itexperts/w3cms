@php
    ...
    $post_type_gallery2		= $blog_options['post_type_gallery2'] ?? null;
		...
		<div class="row">
			...
			<div class="{{ $classes }}">
				...
				<div class="{{ $blog_classes }}">
                    <div class="dz-media mySwiper">
                        @if (!empty($post_type_gallery2))
                        @php
                            $post_type_gallery2 = explode(',',$post_type_gallery2);
                        @endphp
                            <div class="swiper-container post-swiper-thumb">
                                <div class="swiper-wrapper">
                                    @forelse ($post_type_gallery2 as $image_id)
                                    <div class="swiper-slide">
                                        <img src="{{ DzHelper::getStorageImage('storage/blog-options/'.@$image_id) }}" alt="{{ __('Blog Image') }}">
                                    </div>
                                    @empty
                                    @endforelse
                                </div>
                            ...
                            <div class="swiper-container post-swiper-thumbs mt-2">
                                <div class="swiper-wrapper">
                                    @forelse ($post_type_gallery2 as $image_id)
                                    <div class="swiper-slide">
                                        <img src="{{ DzHelper::getStorageImage('storage/blog-options/'.@$image_id) }}" alt="{{ __('Blog Image') }}">
