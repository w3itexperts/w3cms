...
@if ($footer_on)
<footer class="site-footer style-1  footer-action" style="background-image: url({{ theme_asset('images/background/footer-bg.png') }}); " id="footer">
    ...
    @if(!empty($footer_bg_image))
		<img class="girl-img" src="{{DzHelper::getStorageImage('storage/theme-options/'.@$footer_bg_image)}}" alt="{{__('Image')}} "/>
    @endif
