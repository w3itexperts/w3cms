...
<header class="site-header mo-left header header-transparent style-1">
    @if (config('ThemeOptions.header_1_top_bar',true))
        @include('elements/header_top_bar_1')
    @endif
				...
				<div class="box-header clearfix d-lg-flex d-block">
					...
					<div class="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                        ...
                        <div class="sidebar-footer text-center">
							<div class="dz-login-register mt-2">
                                @if (!\Auth::check() && $show_login_registration)
                                    ...
                                    @if(!empty($mobile_header_register_on))
                                        <a href="{{ route('admin.register') }}" class="dz-register-btn btn btn-primary shadow-primary btn-skew d-lg-none">
