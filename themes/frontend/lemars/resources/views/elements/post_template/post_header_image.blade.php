...
<div class="section-full gutenberg-sc bg-white">
	<div class="container">
		<div class="wp-block-image alignfullwide">
			<div class="category-box dz-overlay center large overlay-medium">
				...
				<div class="category-info">
					...
					<div class="d-flex justify-content-center gap-4"> 
                        ...
                        <div class="category-style">{{ DzHelper::theme_lang($blogcategory->title) }}</div>
                        @empty
                        <div class="category-style">{{ DzHelper::theme_lang('Uncatagorized') }}</div>
                        @endforelse
					</div>
	                ...
	                @endphp
					<h1 class="text-white">{{ DzHelper::theme_lang($blog_visibility) }}{{ DzHelper::theme_lang( $blog->title)}}</h1>
					<div class="sep"></div>
				</div>
			</div>
		</div>
