									...
									<tr>
										...
										<td class="text-center">
											@can('Controllers > BlogsController > admin_edit')
												<a href="{{ route('cpt.blog.admin.edit', ['id' => $blog->id, 'post_type' => $post_type['name']]) }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="icon-pencil"></i></a>
											@endcan
											@can('Controllers > BlogsController > admin_destroy')
												<a href="{{ route('cpt.blog.admin.admin_trash_status', ['id' => $blog->id, 'post_type' => $post_type['name']]) }}" class="btn btn-danger shadow btn-xs sharp"><i class="icon-trash-2"></i></a>
											@endcan
										</td>
									</tr>
								@empty
