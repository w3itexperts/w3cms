                                ...
                                @forelse ($allCpts as $cpt)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @can('WCPT > W3CPTController > save')
                                                <a href="{{ route('cpt.admin.save', $cpt->id) }}" class="btn btn-primary shadow btn-xs sharp me-1"><i class="icon-pencil"></i></a>
                                            @endcan
                                            @can('WCPT > W3CPTController > trash_cpt')
                                                <a href="{{ route('cpt.admin.trash', $cpt->id) }}" class="btn btn-danger shadow btn-xs sharp"><i class="icon-trash-2"></i></a>
                                            @endcan
                                        </td>
                                    </tr>
                                @empty
