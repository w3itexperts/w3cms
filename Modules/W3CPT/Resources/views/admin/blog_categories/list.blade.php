										...
										@forelse ($blog_categories as $blog_category)
											<tr>
												...
												<td class="text-center">
													<a href="{{ route('cpt.blog_category.admin.list', ['post_type' => $post_type['name'], 'taxonomy' => $taxonomy['name'], 'id' => $blog_category['id']]) }}" class="btn btn-primary shadow btn-xs sharp me-1" title="{{ __('common.edit') }}"><i class="icon-pencil"></i></a>
													<a href="{{ route('cpt.blog_category.admin.destroy', ['post_type' => $post_type['name'], 'taxonomy' => $taxonomy['name'], 'id' => $blog_category['id']]) }}" class="btn btn-danger shadow btn-xs sharp" title="{{ __('common.delete') }}"><i class="icon-trash-2"></i></a>
												</td>
											</tr>
										@empty
