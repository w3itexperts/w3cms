...
class MaterialCompaniesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('solarmitra::admin.material-companies.index',compact('page_title','material_companies'));
    }
    ...
    public function ajax_modal(Request $request, $id = null)
    {
        ...
        if ($request->ajax()) {
            return view('solarmitra::admin.material-companies.modal',compact('company','selectedCategoryIds'));
        }

        return view('solarmitra::admin.material-companies.ajax_modal');
    }
    ...
    public function store(Request $request)
    {
       ...
       $company->categories()->sync($request->material_category_id);
        ...
        $notificationObj->notification_entry('MATERIALCOMPANY-ANMC', $company->id, auth()->id(), config('constants.superadmin'));
        ...
        return redirect()->route('admin.solarmitra.material_companies.index');
    ...
    public function update(Request $request, $id)
    {
        ...
        /* Send Event Notification */
        $notificationObj        = new Notification();
        $notificationObj->notification_entry('MATERIALCOMPANY-UMC', $company->id, auth()->id(), config('constants.superadmin'));
        /* End Send Event Notification */
    ...
    public function destroy($id)
    {
        ...
        /* Send Event Notification */
        $notificationObj        = new Notification();
        $notificationObj->notification_entry('MATERIALCOMPANY-DMC', $materialCompany->id, auth()->id(), config('constants.superadmin'));
        /* End Send Event Notification */
