	...
	<div class="row page-titles mx-0 mb-3">
		...
		<div class="col-sm-6 p-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('solarmitra::solarmitra.add') }} {{ __('solarmitra::solarmitra.business') }}</a></li>
			</ol>
		</div>
	</div>

	<form action="{{ route('admin.solarmitra.businesses.store') }}" method="post" enctype="multipart/form-data">
		@csrf
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="form-group col-sm-6">
								<label for="dz-password">{{ __('solarmitra::solarmitra.password') }}<span class="text-danger">*</span></label>
							...
							<div class="form-group col-sm-6">
								<label for="dz-con-password">{{ __('solarmitra::solarmitra.confirm_password') }}<span class="text-danger">*</span></label>
								<div class="input-group">
						...
						<div class="row">
							<div class="form-group col-md-3">
								...
								<input type="text" name="company_name" class="form-control" id="company_name" placeholder="{{ __('solarmitra::solarmitra.company_name') }}" value="{{ old('company_name') }}">
								@error('company_name')
									<p class="text-danger">
										{{ $message }}
									</p>
							...
							<div class="form-group col-md-3">
								...
								<input type="number" name="phone" class="form-control" id="Phone" placeholder="{{ __('solarmitra::solarmitra.phone') }}" value="{{ old('phone') }}" >
								@error('phone')
									<p class="text-danger">
										{{ $message }}
									</p>
							...
							<div class="form-group col-md-3">
								...
								<input type="text" name="gst_no" class="form-control" id="gst_no" value="{{ old('gst_no') }}" placeholder="{{ __('solarmitra::solarmitra.gst_no') }}" >
								@error('gst_no')
									<p class="text-danger">
										{{ $message }}
									</p>
							...
							<div class="form-group col-md-3">
								...
								<input type="text" name="pan_no" class="form-control" id="pan_no" value="{{ old('pan_no') }}" placeholder="{{ __('solarmitra::solarmitra.pan_no') }}" >
								@error('pan_no')
									<p class="text-danger">
										{{ $message }}
									</p>
							...
							<div class="form-group col-md-6">
								...
								<textarea name="about" class="form-control h-auto" id="About" rows="5">{{ old('about') }}</textarea>
								@error('about')
									<p class="text-danger">
										{{ $message }}
									</p>
							...
							<div class="form-group col-md-6">
								<div class=" img-parent-box"> 
									<img src="{{ asset('images/noimage.jpg') }}" class="img-for-onchange zoomable rounded mb-2"  alt="{{ __('solarmitra::solarmitra.image') }}" width="150px" title="{{ __('solarmitra::solarmitra.image') }}"> 
						...
						<h4 class="head-sefrator">Address</h4>
