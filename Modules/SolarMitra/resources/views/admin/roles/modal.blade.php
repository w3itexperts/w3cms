<form method="post" action="{{@$business_role->id ? route('admin.solarmitra.business_roles.update',@$business_role->id) : route('admin.solarmitra.business_roles.store')}}" class="AjaxModalForm">
    @csrf
        ...
        <div class="row">
            ...
            <div class="col-6 mb-3">
                ...
                <select name="parent_id" class="form-select  text-primary">
                    ...
                    @forelse ($business_roles->pluck('name','id') as $role_id => $name)
            ...
            <div class="col-6 mb-3">
                ...
                <select name="status" class="form-select  text-primary">
                    <option value="0" @selected(@$business_role->status == 0)>Inactive</option>
                    <option value="1" @selected(@$business_role->status == 1)>Active</option>
                </select>
