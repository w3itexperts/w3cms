<div class="row">
	...
	<div class="col-md-2 border-end">
		<ul class="nav leads-nav nav-pills nav-pills-all flex-column align-items-center py-4" id="justify-tab" role="tablist">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									{!! ThemeOption::CreateField([
											...
											'old_field_value'=>old('configuration.module_code'),

											],'configuration') !!}
									@error('configuration.module_code')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									{!! ThemeOption::CreateField([
											...
											'old_field_value'=>old('configuration.field_key'),
										],'configuration') !!}
									@error('configuration.field_key')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									{!! ThemeOption::CreateField([
											...
											'old_field_value'=>old('configuration.display_title'),
										],'configuration') !!}
									@error('configuration.display_title')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									...
									@error('configuration.description')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									...
									@error('configuration.industry_code')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row">
								...
								<div class="col-sm-10">
									...
									@error('configuration.config_group')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
						</div>
						...
						<div class="col-xl-12 border rounded p-3 mb-3">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									...
									@error('configuration.value_type')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									...
									@error('configuration.field_type')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row mb-3 align-items-center">
								...
								<div class="col-sm-10">
									...
									@error('configuration.is_multiple')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row">
								...
								<div class="col-sm-10">
									...
									@error('configuration.field_value')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
						</div>
						...
						<div class="col-xl-12 border p-3 rounded mb-3">
							<div class="row align-items-center mb-2">
								...
								<div class="col-sm-10">
									...
									@error('configuration.options_json')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									...
									@error('configuration.validation_rules_json')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
						</div>
						...
						<div class="col-xl-12 border rounded p-3 mb-3">
							<div class="row align-items-center mb-3">
								...
								<div class="col-sm-10">
									...
									@error('configuration.is_required')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									...
									@error('configuration.min_value')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									...
									@error('configuration.max_value')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									...
									@error('configuration.step_value')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row">
								...
								<div class="col-sm-10">
									...
									@error('configuration.regex_pattern')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
						</div>
				</div>
						...
						<div class="col-xl-12 border rounded p-3 mb-3">
							...
							<div class="row align-items-center mb-3">
								...
								<div class="col-sm-10">
									...
									@error('configuration.is_readonly')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row align-items-center mb-3">
								...
								<div class="col-sm-10">
									...
									@error('configuration.is_hidden')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									...
									@error('configuration.depends_on_key')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									...
									@error('configuration.depends_on_value')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
						</div>
						...
						<div class="col-xl-12 border rounded p-3 mb-3">
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									...
									@error('configuration.display_order')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									...
									@error('configuration.help_text')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
							<div class="row align-items-center">
								...
								<div class="col-sm-10">
									...
									@error('configuration.is_active')<p class="text-danger">{{ $message }}</p> @enderror
								</div>
							</div>
						</div>
