...
<div class="container-fluid">
    ...
    <form action="{{ route('admin.solarmitra.materials.update',@$material->id) }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6 mb-3 ">
                                ...
                                <input type="number" step="any" min="0" class="form-control" name="selling_price" id="MaterialSellingPrice" value="{{@$material->selling_price}}" {{  @$material_categories[@$material->material_category_id] == 'Structure' ? 'readonly' : ''}}>
                                @error('selling_price')
                                    <div class="invalid-feedback d-block">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-6 mb-3 ">
                                ...
                                <input type="number" step="any" min="0" class="form-control" name="gst" value="{{@$material->gst}}">
                                @error('gst')
                                    <div class="invalid-feedback d-block">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('admin.solarmitra.materials.index') }}" class="btn btn-danger">{{ __('solarmitra::solarmitra.back') }}</a>
                    </div>
                </div>
            </div>  
        </div>
