                ...
                <div class="card h-auto">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-footer text-end">
                            ...
                            <a href="{{ route('admin.solarmitra.material_units.list') }}" class="btn btn-danger">{{ __('solarmitra::solarmitra.back') }}</a>
                        </div>
                    </form>
                </div>
            ...
            <div class="col-xl-8">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div class="clearfix gap-2 d-flex align-items-center">
                        ...
                        <a href="{{ route('admin.solarmitra.material_units.list') }}" class="btn btn-danger">{{ __('solarmitra::solarmitra.reset') }}</a> 
                    </div>
                </div>
                <!-- End - Filtering -->
                            ...
                            <tbody>
                                @forelse ($material_units as $material_unit)    
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.solarmitra.material_units.list', $material_unit->id) }}" class="btn btn-primary shadow py-2 btn-xs sharp me-1" title="{{ __('solarmitra::solarmitra.edit') }}"><i class="icon-pencil"></i></a>
                                            <a href="{{ route('admin.solarmitra.material_units.destroy', $material_unit->id) }}" class="btn btn-danger shadow btn-xs py-2 sharp deleteRecord" title="{{ __('solarmitra::solarmitra.delete') }}"><i class="icon-trash-2"></i></a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
