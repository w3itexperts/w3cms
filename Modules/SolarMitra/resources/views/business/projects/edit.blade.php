...
<div class="container-fluid">
    <form action="{{ route('business.solarmitra.projects.update',$project_id) }}" method="Post" enctype="multipart/form-data">
        <fieldset {{ !empty($project) && $project->status == config('solarmitra.projects_status_keys.Archived') ? 'disabled' : '' }}>
            <input type="hidden" name="todo" id="ToDo" value="ProjectEditForm">
