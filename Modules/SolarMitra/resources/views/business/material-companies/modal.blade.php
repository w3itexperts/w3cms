<form method="post" action="{{@$company->id ? route('business.solarmitra.material_companies.update',@$company->id) : route('business.solarmitra.material_companies.store')}}" class="AjaxModalForm">
    @csrf
    ...
    <div class="modal-body">
        <div class="row">
            <div class="col-sm-6 mb-3">
                <label class="form-label">{{ __('solarmitra::solarmitra.title') }}</label>
