<form method="post" action="{{@$material->id ? route('business.solarmitra.materials.update',@$material->id) : route('business.solarmitra.materials.store')}}" class="AjaxModalForm">
    @csrf
    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-6 mb-3 ">
                <label class="form-label">{{ __('solarmitra::solarmitra.selling_price') }} </label>
