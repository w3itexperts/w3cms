        ...
        <nav class="navbar navbar-expand">
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right main-notification">
                                    ...
                                    <ul class="d-flex align-items-center justify-content-around">
                                        ...
                                        <li class="nav-item dropdown notification_dropdown">
                                            <a class="nav-link bell dz-fullscreen d-flex align-items-center justify-content-center" title="Fullscreen" href="#">
                                                <i id="icon-full" class="icon-maximize"></i> 
                                                <i id="icon-minimize" class="icon-minimize"></i>
                                            </a>
                                        </li>          
                                    </ul>
                                </div>
                    ...
                    <li class="nav-item dropdown notification_dropdown d-none d-md-flex">
                        <a class="nav-link bell dz-theme-mode" title="Dark Mode" href="#">
                            <i id="icon-light" class="icon-sun"></i>

                            <i id="icon-dark" class="icon-moon"></i>
                        </a>
                    </li>
                    <li class="nav-item dropdown notification_dropdown d-none d-md-flex">
                    ...
                    <li class="nav-item dropdown header-profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a href="{!! route('business.solarmitra.users.profile') !!}" class="dropdown-item ai-icon">
                                <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                <span class="ms-2">{{ __('common.profile') }} </span>
                            </a>
                            <form method="POST" action="{{ route('business.solarmitra.auth.logout') }}">
                                @csrf
                                <a href="{!! route('business.solarmitra.auth.logout'); !!}" class="dropdown-item ai-icon LogOutBtn">
